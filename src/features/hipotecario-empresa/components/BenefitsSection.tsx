  ...
  const benefits = [
    {
      ...
      description: "Dinero disponible cuando tu proyecto lo exige. Sin demoras innecesarias, procesos de solo 15 días.",
      icon: Zap,
      color: "gold",
    },
    {
      title: "Flexibilidad Total",
      description: "Tú eliges cómo pagar: Periodos de gracia, cuotas de solo interés o capital+interés personalizado.",
      icon: LayoutGrid,
      color: "primary",
    },
    {
      title: "Alcance Financiero",
