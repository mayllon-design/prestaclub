      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-5xl font-extrabold text-foreground mb-4">Calcula tu Liquidez Empresarial</h2>
              ...
              <div>
                ...
                <div className="space-y-4 mb-10">
                  <div className="flex items-center gap-3">
                    ...
                    <p className="text-white/80 font-body text-sm font-medium">Tasa referencial desde 1.2% mensual</p>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="h-6 w-6 rounded-full bg-white/10 flex items-center justify-center">
                      <div className="h-2 w-2 rounded-full bg-gold" />
              ...
              <div className="space-y-6 pt-10 border-t border-white/10">
                ...
                <div className="flex items-start gap-3 bg-white/5 p-4 rounded-2xl border border-white/5">
                  ...
                  <p className="text-[10px] md:text-[11px] text-white/40 leading-relaxed font-body italic uppercase tracking-tighter">
                    *Toda operación está sujeta a previa evaluación de antecedentes legales y financieros. Los montos, plazos y tasas definitivas se establecerán en el contrato final.
                  </p>
                </div>
              </div>
            </div>
