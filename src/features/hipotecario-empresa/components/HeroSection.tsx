    ...
    <section className="relative overflow-hidden hero-gradient py-12 md:py-20">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-7xl font-extrabold text-primary-foreground leading-tight mb-4 animate-in fade-in slide-in-from-bottom-4 duration-1000 flex flex-col items-center">
          ...
          <h2 className="text-lg md:text-2xl font-semibold text-gold mb-6 max-w-2xl mx-auto animate-in fade-in slide-in-from-bottom-5 duration-1000">
            Préstamo de capital para tu empresa con garantía hipotecaria
          </h2>
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 md:gap-16 opacity-70 grayscale hover:opacity-100 hover:grayscale-0 transition-all duration-500">
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                <div className="text-xs font-bold text-white uppercase tracking-tighter">Registrados en la</div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                <div className="text-xs font-bold text-white uppercase tracking-tighter">Miembros de</div>
                <div className="text-lg font-black text-white">Fintech Perú</div>
              </div>
            </div>
