            ...
            <section className="section-padding bg-background">
                <div className="container mx-auto max-w-5xl">
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                        <a
                            href={getWhatsAppUrl("Hola PrestaClub, necesito información.")}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="card-elevated p-6 text-center hover:shadow-2xl transition-shadow group"
                        ...
                        >
                            ...
                            <p className="text-sm text-muted-foreground font-body">
                                {whatsappNumber === '51921010200' ? '+51 921 010 200' : '+51 919 000 200'}
                            </p>
                        </a>
            ...
            <section className="hero-gradient section-padding">
                <div className="container mx-auto text-center max-w-3xl">
                    ...
                    <Button variant="hero" size="xl" asChild>
                        <a
                            href={getWhatsAppUrl("Hola PrestaClub, prefiero que me llamen.")}
                            target="_blank"
                            rel="noopener noreferrer"
                            onClick={clearTracking}
                        >
