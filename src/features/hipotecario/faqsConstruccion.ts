// FAQ de la landing de financiamiento para construcción. Fuente única para el acordeón visible y el FAQPage JSON-LD.

import type { FaqItem } from "@/features/hipotecario/faqsCapitalTrabajo";

export const faqsConstruccion: FaqItem[] = [
  {
    q: "¿Para qué puedo usar el financiamiento para construcción?",
  ...
  },
  {
    ...
    a: "Lo esencial: tu DNI (y el del cónyuge o garante), la partida registral del inmueble o terreno y el HR y PU (Autovalúo Municipal). Si eres empresa, además el RUC. No exigimos un historial crediticio impecable ni boletas de pago para iniciar la evaluación.",
  },
];
