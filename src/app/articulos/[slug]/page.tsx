      ...
      <article className="min-h-screen pb-20 overflow-hidden">
        ...
        <div className="relative h-[45vh] md:h-[60vh] w-full">
          ...
          <div className="absolute inset-0 flex items-end">
            <div className="container mx-auto px-4 pb-28 md:pb-32">
              <Link href="/articulos" className="inline-flex items-center text-white/80 hover:text-white text-sm font-medium drop-shadow mb-3 md:mb-4">
              ...
              <div className="max-w-3xl">
                ...
                <h1 className="text-2xl md:text-4xl lg:text-5xl font-extrabold text-white leading-tight break-words">
                  {article.title}
                </h1>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 -mt-24 relative z-10 mb-20">
          <div className="max-w-5xl mx-auto">
            <div className="bg-white rounded-3xl shadow-2xl p-6 md:p-16 overflow-hidden border border-muted/20">
              ...
              <div 
                className="article-content prose prose-base max-w-none prose-headings:text-primary prose-gold font-body prose-img:rounded-2xl prose-img:shadow-xl prose-a:text-gold hover:prose-a:text-gold/80 break-words"
